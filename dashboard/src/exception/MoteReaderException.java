 ...
 */
public class MoteReaderException extends RealException {

	/**
	 * Constructor
	 */
	public MoteReaderException() {
	}
	...
	* @param message 	The exception message
	 */
	public MoteReaderException(final String message) {
		super(message);
	 ...
	 */
	public MoteReaderException(final Throwable origin) {
		super(origin);
	 ...
	 * @param origin		The exception at origin of the error
	 */
	public MoteReaderException(final String message, final Throwable origin) {
